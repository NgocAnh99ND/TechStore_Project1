...
<main>
    <section class="about-us container">
        <div class="mw-930">
            <h2 class="page-title text-center">Về TECHSTORE</h2>
        </div>
    ...
    <img loading="lazy" class="w-100 d-block rounded shadow" 
         src="{{ asset('theme/client/images/about/banner1.jpg') }}" alt="About TechStore" style="height: auto; max-height: 350px; width: auto; max-width: 80%; margin-left: 105px; ">
            ...
            <div class="mw-930">
                ...
                <p class="fs-6 fw-medium mb-4">Chúng tôi cam kết cung cấp những sản phẩm điện thoại chất lượng cao nhất với dịch vụ tận tâm.</p>
                <p class="mb-4">Ngay từ những ngày đầu, TechStore được hình thành và phát triển với sứ mệnh cung cấp các thiết bị công nghệ tiên tiến nhất. Chúng tôi không ngừng đổi mới và nỗ lực đáp ứng nhu cầu của khách hàng, tạo ra những sản phẩm không chỉ đẹp mà còn bền bỉ.
                    <div class="col-md-6">
                        <h5 class="mb-3">
                        Sứ mệnh của chúng tôi</h5>
                        <p class="mb-3">
                        Mang đến trải nghiệm tốt nhất cho khách hàng với sản phẩm và dịch vụ chất lượng.</p>
                    </div>
                    <div class="col-md-6">
                        <h5 class="mb-3">Tầm nhìn của chúng tôi</h5>
                        <p class="mb-3">
                        Trở thành thương hiệu dẫn đầu trong ngành công nghệ di động tại Việt Nam.</p>
                    </div>
                </div>
            </div>
            <div class="mw-930 d-lg-flex align-items-lg-center">
                ...
                <div class="content-wrapper col-lg-6 px-lg-4">
                    <h5 class="mb-3">Công ty chúng tôi</h5>
                    <p>
                    TechStore tự hào cung cấp các sản phẩm điện thoại cao cấp với thiết kế hiện đại và tính năng vượt trội. Chúng tôi nỗ lực để đảm bảo mỗi sản phẩm đều đáp ứng các tiêu chuẩn chất lượng và hiệu suất cao nhất.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="service-promotion horizontal container mw-930 pt-0 mb-md-4 pb-md-4 mb-xl-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center mb-4 pb-1 mb-md-0">
                ...
                <h3 class="service-promotion__title fs-6 text-uppercase">Cam kết hoàn tiền</h3>
                <p class="service-promotion__content text-secondary">Chúng tôi hoàn tiền trong vòng 30 ngày.</p>
            </div>
        </div>
    </section>
    ...
    <div class="aside aside_right overflow-hidden cart-drawer" id="cartDrawer">
        <div class="aside-header d-flex align-items-center">
            <h3 class="text-uppercase fs-6 mb-0">SHOPPING BAG 1 ( <span class="cart-amount js-cart-items-count">1</span> )
            </h3>
            <button class="btn-close-lg js-close-aside btn-close-aside ms-auto"></button>
        </div><!-- /.aside-header -->
