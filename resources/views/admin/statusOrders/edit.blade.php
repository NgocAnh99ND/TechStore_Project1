            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Status order edit</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="mt-3">
                                            ...
                                            <input type="number" class="form-control @error('display_order') is-invalid @enderror" name="display_order" id="display_order" value="{{$statusOrder->display_order }}">
                                            @error('display_order')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
