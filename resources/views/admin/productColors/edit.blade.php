...
@section('content')
    ...
    <form action="{{ route('admin.productColors.update', $productColor->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method("PUT")
        <div class="row">
            <div class="col-lg-12">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <div class="form-check form-switch form-switch-{{ $value['color'] }} d-flex align-items-center">
                                                        <input class="form-check-input me-2" type="checkbox" role="switch"
                                                               ...
                                                               {{ isset($productColor) && $productColor->is_active == 1 ? 'checked' : '' }}>
